...
|-----------|------------|
| Firewall & Network | pfSense (WAN / LAN / DMZ) |
| Local Honeypot | Raspberry Pi 5 + Cowrie SSH/Telnet |
| Cloud Sensor | AWS EC2 + Security Groups |
| Connectivity | Site-to-Site VPN (IPsec / WireGuard) |
| SIEM & Monitoring | ELK Stack (Elasticsearch · Logstash · Kibana) |
| Analysis | Brute-force patterns · Origin countries · Attack methods |
